...
parser.add_argument('--src_emb_dim', type=int, default=256, help='size of source word embedding')
parser.add_argument('--target_emb_dim', type=int, default=256, help='size of target word embedding')
parser.add_argument('--src_rnn_dim', type=int, default=256, help='number of source hidden layer')
parser.add_argument('--dec_hidden_dim1', type=int, default=256, help='number of target hidden layer')
parser.add_argument('--atten_dim', type=int, default=256, help='number of target attention layer')
parser.add_argument('--dec_hidden_dim2', type=int, default=256, help='number of maxout layer')
